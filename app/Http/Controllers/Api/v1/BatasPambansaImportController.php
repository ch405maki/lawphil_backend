...
use App\Imports\BatasPambansaImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class BatasPambansaImportController extends Controller
{
    public function import(Request $request)
    {
        try {
            ...
            $import = new BatasPambansaImport($file, 1);
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only B.P. Number and Date are required)');
            ...
            $examples = [
                ...
                'E2' => 'Some description',
                'F2' => 'https://example.com/bp',
                'G2' => 'Yes',
                'H2' => '/uploads/pdfs/bp_123.pdf',
            ...
            header('Content-Disposition: attachment; filename="batas_pambansa_template.xlsx"');

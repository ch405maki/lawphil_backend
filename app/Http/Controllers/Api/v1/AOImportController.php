...
use App\Imports\AOImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class AOImportController extends Controller
{
    /**
     * Import administrative order from Excel file
     */
    public function import(Request $request)
    {
        try {
            ...
            $import = new AOImport($file, 1); // Hardcoded user_id for now
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only Administrative Order Number and Date are required)');
            ...
            // Add example data
            $examples = [
                'A2' => 'Administrative Order No. 123456',
                'B2' => '2024-01-15',
                'C2' => '123 SCRA 456',
                ...
                'A3' => 'Administrative Order No. 123457',
                'B3' => '2024-02-20',
                'C3' => '',
                'D3' => '',
                'E3' => '',
                ...
                'A4' => 'Administrative Order No. 123458',
                'B4' => '2024-03-10',
                'C4' => '',
                'D4' => '',
                'E4' => '',
            ...
            header('Content-Disposition: attachment; filename="ao_template.xlsx"');

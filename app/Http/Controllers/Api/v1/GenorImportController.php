...
use App\Imports\GenorImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class GenorImportController extends Controller
{
    /**
     * Import general order from Excel file
     */
    public function import(Request $request)
    {
        try {
            ...
            $import = new GenorImport($file, 1); // Hardcoded user_id for now
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only General Order Number and Date are required)');
            ...
            header('Content-Disposition: attachment; filename="genor_template.xlsx"');

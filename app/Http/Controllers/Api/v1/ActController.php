...
{
    private const NUMBER_COLUMN = 'act_number';
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Act record created successfully',
                'data' => $act
            ], 201);
    ...
    {
        try {
            $record = Act::findOrFail($id);

            $validator = Validator::make($request->all(), [
                'act_number' => 'sometimes|required|string|max:255',
            ...
            return response()->json([
                'success' => true,
                'message' => 'Act record updated successfully',
                'data' => $record
            ]);
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Act record deleted successfully'
            ]);

...
{
    private const NUMBER_COLUMN = 'bp_number';
    ...
    public function store(Request $request)
    {
        try {
            ...
            $bp = BatasPambansa::create([
                'user_id' => 1,
                'bp_number' => $request->bp_number,
                'date' => $request->date,
            ...
            return response()->json([
                'success' => true,
                'message' => 'Batas Pambansa record created successfully',
                'data' => $bp
            ], 201);
    ...
    {
        try {
            $record = BatasPambansa::findOrFail($id);

            $validator = Validator::make($request->all(), [
                'bp_number' => 'sometimes|required|string|max:255',
            ...
            return response()->json([
                'success' => true,
                'message' => 'Batas Pambansa record updated successfully',
                'data' => $record
            ]);
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Batas Pambansa record deleted successfully'
            ]);

...
class MOController extends Controller 
{
    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'mo_number' => 'required|string|max:255',
                'date' => 'required|date',
    ...
    public function update(Request $request, $id) 
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Memorandum Order record updated successfully',
                'data' => $record
            ]);
    ...
    public function destroy($id) 
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Memorandum Order record deleted successfully'
            ]);
    ...
    public function bulkDelete(Request $request)
    {
        try {
            ...
            $deleted =  MO::whereIn('id', $request->ids)->delete();

...
use App\Imports\ProclamationImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class ProclamationImportController extends Controller
{
    /**
    ...
    public function import(Request $request)
    {
        try {
            ...
            $import = new ProclamationImport($file, 1); // Hardcoded user_id for now
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only Proc Number and Date are required)');
            ...
            header('Content-Disposition: attachment; filename="proclamation_template.xlsx"');

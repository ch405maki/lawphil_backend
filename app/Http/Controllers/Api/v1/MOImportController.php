...
use App\Imports\MOImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class MOImportController extends Controller
{
    /**
     * Import memorandum ORDER from Excel file
     */
    public function import(Request $request)
    {
        try {
            ...
            $import = new MOImport($file, 1); // Hardcoded user_id for now
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only Memorandum Order Number and Date are required)');
            ...
            header('Content-Disposition: attachment; filename="mo_template.xlsx"');

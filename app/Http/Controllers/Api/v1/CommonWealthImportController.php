...
use App\Imports\CommonWealthImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class CommonWealthImportController extends Controller
{
    public function import(Request $request)
    {
        try {
            ...
            $import = new CommonWealthImport($file, 1);
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only C.A. Number and Date are required)');
            ...
            $examples = [
                ...
                'E2' => 'Some description',
                'F2' => 'https://example.com/ca',
                'G2' => 'Yes',
                'H2' => '/uploads/pdfs/ca_123.pdf',
            ...
            header('Content-Disposition: attachment; filename="commonwealth_template.xlsx"');

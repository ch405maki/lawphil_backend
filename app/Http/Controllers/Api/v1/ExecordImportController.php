...
use App\Imports\ExecordImport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;

class ExecordImportController extends Controller
{
    /**
    ...
    public function import(Request $request)
    {
        try {
            ...
            $import = new ExecordImport($file, 1); // Hardcoded user_id for now
    ...
    public function downloadTemplate()
    {
        try {
            ...
            $sheet->setCellValue('K2', '* = Required field (only Executive Order Number and Date are required)');
            ...
            header('Content-Disposition: attachment; filename="execord_template.xlsx"');

...
class RepublicController extends Controller 
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Republic record created successfully',
                'data' => $republic
            ], 201);
    ...
    {
        try {
            $record = Republic::findOrFail($id);

            $validator = Validator::make($request->all(), [
                'ra_number' => 'sometimes|required|string|max:255',
            ...
            return response()->json([
                'success' => true,
                'message' => 'Republic record updated successfully',
                'data' => $record
            ]);
    ...
    public function destroy($id) 
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Republic record deleted successfully'
            ]);
    ...
    public function bulkDelete(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                'ids' => 'required|array',
                'ids.*' => 'integer|exists:republic,id'
            ]);
            ...
            $deleted = Republic::whereIn('id', $request->ids)->delete();

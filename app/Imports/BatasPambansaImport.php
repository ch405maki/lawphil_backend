...
class BatasPambansaImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $bpNumber        = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($bpNumber, $dateValue, $rowNumber);
    ...
    protected function validateRequiredFields($bpNumber, $dateValue, $rowNumber)
    {
        if (empty($bpNumber)) {
            throw new \Exception("Row {$rowNumber}: B.P. Number is required");
        }

...
class MCImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $mcNumber        = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($mcNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($mcNumber, $dateValue, $rowNumber)
    {
        if (empty($mcNumber)) {
            throw new \Exception("Row {$rowNumber}: MC Number is required");
        }

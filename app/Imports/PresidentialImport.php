...
class PresidentialImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $pdNumber = $this->cleanValue($row[0] ?? null);
            ...
            $pdfAvailabilityBool = !empty($pdf_path); // Set to true if pdf_path is provided

            // Validate required fields
            $this->validateRequiredFields($pdNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($pdNumber, $dateValue, $rowNumber)
    {
        if (empty($pdNumber)) {
            throw new \Exception("Row {$rowNumber}: Presidential Decree No. is required");
        }

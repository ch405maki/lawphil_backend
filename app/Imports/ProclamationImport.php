...
class ProclamationImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $procNumber      = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($procNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($procNumber, $dateValue, $rowNumber)
    {
        if (empty($procNumber)) {
            throw new \Exception("Row {$rowNumber}: Proc Number is required");
        }

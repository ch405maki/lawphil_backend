...
class ActImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $actNumber       = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($actNumber, $dateValue, $rowNumber);
    ...
    protected function validateRequiredFields($actNumber, $dateValue, $rowNumber)
    {
        if (empty($actNumber)) {
            throw new \Exception("Row {$rowNumber}: Act Number is required");
        }

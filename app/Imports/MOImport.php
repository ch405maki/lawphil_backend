...
class MOImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $moNumber        = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($moNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($moNumber, $dateValue, $rowNumber)
    {
        if (empty($moNumber)) {
            throw new \Exception("Row {$rowNumber}: Memorandum Order Number is required");
        }

...
class ExecordImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $execordNumber   = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($execordNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($execordNumber, $dateValue, $rowNumber)
    {
        if (empty($execordNumber)) {
            throw new \Exception("Row {$rowNumber}: Executive Order Number is required");
        }

...
class RepublicImport
{
    ...
    protected function processRow($row, $rowNumber)
    {
        try {
            ...
            $raNumber        = $this->cleanValue($row[0] ?? null);
            ...
            $this->validateRequiredFields($raNumber, $dateValue, $rowNumber);
     ...
     * Validate required fields
     */
    protected function validateRequiredFields($raNumber, $dateValue, $rowNumber)
    {
        if (empty($raNumber)) {
            throw new \Exception("Row {$rowNumber}: R.A. Number is required");
        }

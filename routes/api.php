...
Route::middleware('auth:sanctum')->prefix('jurisprudence')->group(function () {
    Route::post('/', [JurisprudenceController::class, 'store']);
    Route::post('/{id}', [JurisprudenceController::class, 'update']);
    Route::delete('/{id}', [JurisprudenceController::class, 'destroy']);
});
...
Route::prefix('v1/presidential')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [PresidentialController::class, 'index'])->middleware('permission:presidential,view');
    Route::post('/', [PresidentialController::class, 'store'])->middleware('permission:presidential,create');
    Route::post('/{id}', [PresidentialController::class, 'update'])->middleware('permission:presidential,update');
    Route::delete('/{id}', [PresidentialController::class, 'destroy'])->middleware('permission:presidential,delete');
});
...
Route::prefix('v1/proclamations')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [ProclamationController::class, 'index'])->middleware('permission:proclamation,view');
    Route::post('/', [ProclamationController::class, 'store'])->middleware('permission:proclamation,create');
    Route::post('/{id}', [ProclamationController::class, 'update'])->middleware('permission:proclamation,update');
    Route::delete('/{id}', [ProclamationController::class, 'destroy'])->middleware('permission:proclamation,delete');
});
...
Route::prefix('v1/republic')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [RepublicController::class, 'index'])->middleware('permission:republic,view');
    Route::post('/', [RepublicController::class, 'store'])->middleware('permission:republic,create');
    Route::post('/{id}', [RepublicController::class, 'update'])->middleware('permission:republic,update');
    Route::delete('/{id}', [RepublicController::class, 'destroy'])->middleware('permission:republic,delete');
});
...
Route::prefix('v1/execord')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [ExecordController::class, 'index'])->middleware('permission:execord,view');
    Route::post('/', [ExecordController::class, 'store'])->middleware('permission:execord,create');
    Route::post('/{id}', [ExecordController::class, 'update'])->middleware('permission:execord,update');
    Route::delete('/{id}', [ExecordController::class, 'destroy'])->middleware('permission:execord,delete');
});
...
Route::prefix('v1/ao')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [AOController::class, 'index'])->middleware('permission:ao,view');
    Route::post('/', [AOController::class, 'store'])->middleware('permission:ao,create');
    Route::post('/{id}', [AOController::class, 'update'])->middleware('permission:ao,update');
    Route::delete('/{id}', [AOController::class, 'destroy'])->middleware('permission:ao,delete');
});
...
Route::prefix('v1/mo')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [MOController::class, 'index'])->middleware('permission:mo,view');
    Route::post('/', [MOController::class, 'store'])->middleware('permission:mo,create');
    Route::post('/{id}', [MOController::class, 'update'])->middleware('permission:mo,update');
    Route::delete('/{id}', [MOController::class, 'destroy'])->middleware('permission:mo,delete');
});
...
Route::prefix('v1/mc')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [MCController::class, 'index'])->middleware('permission:mc,view');
    Route::post('/', [MCController::class, 'store'])->middleware('permission:mc,create');
    Route::post('/{id}', [MCController::class, 'update'])->middleware('permission:mc,update');
    Route::delete('/{id}', [MCController::class, 'destroy'])->middleware('permission:mc,delete');
});
...
Route::prefix('v1/genor')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [GenorController::class, 'index'])->middleware('permission:genor,view');
    Route::post('/', [GenorController::class, 'store'])->middleware('permission:genor,create');
    Route::post('/{id}', [GenorController::class, 'update'])->middleware('permission:genor,update');
    Route::delete('/{id}', [GenorController::class, 'destroy'])->middleware('permission:genor,delete');
});
...
Route::prefix('v1/acts')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [ActController::class, 'index'])->middleware('permission:acts,view');
    Route::post('/', [ActController::class, 'store'])->middleware('permission:acts,create');
    Route::post('/{id}', [ActController::class, 'update'])->middleware('permission:acts,update');
    Route::delete('/{id}', [ActController::class, 'destroy'])->middleware('permission:acts,delete');
});
...
Route::prefix('v1/batas-pambansa')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [BatasPambansaController::class, 'index'])->middleware('permission:batas_pambansa,view');
    Route::post('/', [BatasPambansaController::class, 'store'])->middleware('permission:batas_pambansa,create');
    Route::post('/{id}', [BatasPambansaController::class, 'update'])->middleware('permission:batas_pambansa,update');
    Route::delete('/{id}', [BatasPambansaController::class, 'destroy'])->middleware('permission:batas_pambansa,delete');
});
...
Route::prefix('v1/commonwealth')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/', [CommonWealthController::class, 'index'])->middleware('permission:commonwealth,view');
    Route::post('/', [CommonWealthController::class, 'store'])->middleware('permission:commonwealth,create');
    Route::post('/{id}', [CommonWealthController::class, 'update'])->middleware('permission:commonwealth,update');
    Route::delete('/{id}', [CommonWealthController::class, 'destroy'])->middleware('permission:commonwealth,delete');
});

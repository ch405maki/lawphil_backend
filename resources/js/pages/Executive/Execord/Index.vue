...
import ExecordTable from '@/components/Executive/execord/ExecordTable.vue';
...
const breadcrumbs = [ 
  ...
  { title: "Executive Orders", href: "/execord" }
];
...
const goToCreate = () => {
    window.location.href = '/execord/create';
};
</script>
        ...
        <div class="min-h-screen bg-background p-4">
            ...
            <div class="mb-6">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight">Executive Orders</h1>
            ...
            <!-- Executive Orders Table Component -->
            <ExecordTable :refresh-trigger="refreshTrigger" @refresh="refreshTable" />
        </div>
    </AppLayout>
</template>
...
import MOTable from '@/components/Executive/mo/MOTable.vue';
...
const breadcrumbs = [ 
  ...
  { title: "Memorandum Orders", href: "/mo" }
];
...
const goToCreate = () => {
    window.location.href = '/mo/create';
};
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="min-h-screen bg-background p-4">
            ...
            <!-- Memorandum Order Table Component -->
            <MOTable :refresh-trigger="refreshTrigger" @refresh="refreshTable" />
        </div>
    </AppLayout>
</template>
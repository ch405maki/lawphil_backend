...
import ProclamationTable from '@/components/Executive/proclamation/ProclamationTable.vue';
...
const breadcrumbs = [ 
  ...
  { title: "Proclamations", href: "#" }
];

const props = defineProps({
    proclamations: Object,
});
...
const goToCreate = () => {
    window.location.href = '/proclamation/create';
};
</script>

<template>
    <Head title="Proclamations" />
        ...
        <div class="min-h-screen bg-background p-4">
            ...
            <div class="mb-6">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight">Proclamations</h1>
            ...
            <!-- Proclamation Table Component -->
            <ProclamationTable :refresh-trigger="refreshTrigger" @refresh="refreshTable" />
        </div>
    </AppLayout>
</template>
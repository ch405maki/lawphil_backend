...
const uploadFile = async () => {
  ...
  try {
    const response = await axios.post('/api/v1/batas-pambansa/import', formData, {
      headers: {
...
<template>
  <Dialog v-model:open="open">
    ...
    <DialogContent class="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle>Import Batas Pambansa from Excel</DialogTitle>
        <DialogDescription>
          Upload an Excel file to import batas pambansa records.
        </DialogDescription>
      </DialogHeader>
                ...
                <div class="flex flex-col items-center justify-center text-center space-y-3">
                  ...
                  <div class="space-y-1">
                    ...
                    <p class="text-xs text-muted-foreground mt-2">
                      Supports .xlsx, .xls, .csv &bull; Max file size: 10MB
                    </p>
                  </div>
                </div>
              </div>
              ...
              <AlertDescription>
                ...
                <div class="mt-4 p-3 bg-red-100 rounded-md">
                  ...
                  <ul class="list-disc list-inside text-sm mt-1 space-y-1">
                    ...
                    <li>Check that B.P. Number and Date are filled</li>

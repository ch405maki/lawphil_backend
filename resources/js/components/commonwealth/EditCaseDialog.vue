...
const updateCase = async () => {
    ...
    try {
        const response = await axios.post(
            `/api/v1/commonwealth/${props.raData.id}`,
            {
...
<template>
    <Dialog :open="open" @update:open="closeDialog">
        <DialogContent class="max-h-[90vh] max-w-2xl overflow-y-auto">
            <DialogHeader>
                <DialogTitle>Edit Commonwealth Information</DialogTitle>
                <DialogDescription> Update the commonwealth act details below. </DialogDescription>
            </DialogHeader>

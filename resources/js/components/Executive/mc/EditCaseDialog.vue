...
<template>
    <Dialog :open="open" @update:open="closeDialog">
        <DialogContent class="max-h-[90vh] max-w-2xl overflow-y-auto">
            <DialogHeader>
                <DialogTitle>Edit Memorandum Circular Information</DialogTitle>
                <DialogDescription> Update the memorandum circular details below. </DialogDescription>
            </DialogHeader>

...
const defaultItems: InfoItem[] = [
  {
    ...
    description: 'Use our Excel template with the correct column headers. Required fields: Act Number and Date.',
    ...
    <PopoverContent class="w-96 p-0" align="end">
      <div class="p-4 border-b bg-muted/50">
        ...
        <p v-else class="text-sm text-muted-foreground mt-1">
          Everything you need to know about importing act records
        </p>
      </div>
